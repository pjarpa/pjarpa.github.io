...
abstract class Component implements ComponentInterface
{
	...
	public function __construct($slug,$options=array())
	{
		...
		// 	$this->log_message("WARNING: The DOCUMENT_ROOT server setting ($this->doc_root) may be misconfigured. Does not match site root: $this->site_root");
		// 	$this->doc_root = realpath($_SERVER["DOCUMENT_ROOT"]);
		// }
